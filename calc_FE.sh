...
write.table(x = paste0(round(Bar,2)," kT"),row.names = FALSE,col.names = FALSE,file = 'Ion1_Ion2_Solv_barrier',quote = FALSE)
write.table(x = paste0(round(BE,2)," kT"),row.names = FALSE,col.names = FALSE,file = 'Ion1_Ion2_Solv_bindE',quote = FALSE)
dev.off()
EOF
